...
import { useCurrentUserLoans } from '../../hooks/Loan/useCurrentUserLoans';
...
const MyAccountPage = () => {
  ...
  const { loans, loading: loansLoading, error: loansError } = useCurrentUserLoans();
  ...
  if (!user) {
    return (
      <div className="pt-20 px-6">
        <div className="text-gray-600 mb-4">Dados do usuário não encontrados.</div>
      </div>
    );
  }
    ...
    <div className="pt-20 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Loan History */}
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Meus empréstimos</h2>
