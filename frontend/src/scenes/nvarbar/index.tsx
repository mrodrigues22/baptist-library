...
const Navbar = () => {
    ...
    return (
        <nav>
            <div
                className={`${flexBetween} fixed top-0 z-30 w-full py-6 bg-white shadow-md`}>
                    <div className={`${flexBetween} mx-auto w-5/6`}>
                        {/* LEFT SIDE */}
                        <div className={`${flexBetween} w-full`}>
                            <h1 className="text-xl font-bold">bibliotecapib</h1>
                        </div>
                        {/* RIGHT SIDE */}
            ...
            {!isAboveMediumScreens && isMenuToggled && (
                <div className="fixed right-0 bottom-0 z-40 h-full w-[300px] bg-white shadow-lg">
                    ...
                    <div className="ml-[33%] flex flex-col gap-10 text-2xl">
                        <Link page="Acervo" to="/acervo" />
                        <Link page="Empréstimos" to="/emprestimos" />
                        <Link page="Usuários" to="/usuarios" />
                        <Link page="Configurações" to="/configuracoes" />
                        <Link page="Minha conta" to="/minha-conta" />
                    </div>
